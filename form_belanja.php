    ...
    <div class="container" style="margin-top:2em; background-color:#f1f1f1; max-width:75em;">
        <div class="row">
            <div class="col-md-8" style="background-color:white; padding-top:0.5em;">
                ...
                <label class="col-md-4 control-label" for="customer">Kustomer</label>  
                <div class="col-md-5">
                <input id="kustomer" name="kustomer" type="text" placeholder="Masukan Nama kustomer" class="form-control input-md">
